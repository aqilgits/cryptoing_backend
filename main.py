...
line_plot(train[target_col], test[target_col], 'training', 'test', title='test and train', xlabel='price[USD]')
...
line_plot(history.history['loss'], history.history['val_loss'], 'Train loss', 'Validation loss', title='LSTM', xlabel='MSE',
     ylabel='Epochs')
